...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2025 at 03:38 PM
...
(14, '2025-04-08', '09:21:00', 2, 1, 1),
(15, '2025-04-29', '09:31:00', 2, 1, 1),
(16, '2025-04-24', '09:45:00', 2, 5, 1),
...
(1, 350000.00, 120, 'Spacious apartment in the city center.', 'images/house.jpeg', 1, 1),
...
(11, 2500000.00, 175, 'cool house', 'images/house3.jpg', 1, 2),
(14, 50000000.00, 30000, '0', 'images/uploads/prop_6808b587252833.76915815.png', 1, 3);
...
(5, 1, 14, 'EDIT', '{\"Price\":50000000,\"Description\":\"0\",\"Size\":30000,\"Location\":\"Quatres-Bornes\",\"Image\":\"images\\/uploads\\/prop_6808b587252833.76915815.png\"}', 'APPROVED', '2025-04-23 11:40:23', '2025-04-23 11:41:19', 16),
(6, 1, 14, 'DELETE', '{}', 'REJECTED', '2025-04-23 11:41:52', '2025-04-23 13:27:58', 16),
(7, 1, 14, 'DELETE', '{}', 'REJECTED', '2025-04-23 12:01:22', '2025-04-23 13:27:54', 16),
(8, 1, 14, 'DELETE', '{}', 'PENDING', '2025-04-23 13:29:42', NULL, NULL),
...
('about', 'main', '<h2>About Us</h2><p>Some background…</p>'),
('home', 'main', '<p><strong>Test Update at <?= date(\'H:i:s\') ?></strong></p>\n\n\n\n\n');
...
(16, 'Super Admin', 'admin@brajproperty.com', '000-000-0000', 'Admin', '$2y$10$5.QihGvCCQzDsQ1mnsxyTuLLk/OO/X76T1A9tcxCb.q367yu.0yK.'),
...
ALTER TABLE `appointment`
  ...
  ADD CONSTRAINT `fk_Appointment_Client` FOREIGN KEY (`ClientID`) REFERENCES `client` (`ClientID`),
...
ALTER TABLE `property_requests`
  ...
  ADD CONSTRAINT `property_requests_ibfk_2` FOREIGN KEY (`PropertyID`) REFERENCES `property` (`PropertyID`);
